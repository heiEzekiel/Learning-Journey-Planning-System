...
class TestJobRole(TestApp):
    ...
    #     self.assertEqual(response.json['data'][0]['job_role_name'], "Human Resource")
    #     self.assertEqual(response.json['data'][0]['job_role_desc'], "HR's job role")
    #     self.assertEqual(response.json['data'][0]['job_role_status'], 1)
    ...
    #                                 data=json.dumps(request_body),
    #                                 content_type='application/json') 
    #     self.assertEqual(response.json["data"]["job_role_name"], "Software Development")                
    #     self.assertEqual(response.json["data"]["job_role_desc"], "SD's job role")
    ...
    #     self.assertEqual(response.json["message"] , "Job removed successfully")
