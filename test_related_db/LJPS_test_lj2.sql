...
('503','Machine Learning','Machine learing requires knowledge of math and programming.','0');
COMMIT;
...
('603','Data Scientist','Use your statistics and programming skills to create value','0');
COMMIT;
