...
('501','Python 3','Python 3 is the latest programming language that you should know.','1'),
('502','Data Analytics','Data Analytics refers to the ability to derive insights from data, using analytical tools.','1'),
('503','Data Visualization','Data visualization is the graphical representation of information and data.','1');
COMMIT;
...
('602','Data Analyst','Use your analytical skills and tools to derive new insights for our company','1'),
('603','Data Scientist','Use Machine Learning and statistics concepts to build models!','1');
COMMIT;
